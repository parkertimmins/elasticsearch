...
/**
 * {@link AggregatorFunction} implementation for {@link SumSingleIntAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class SumSingleIntAggregatorFunction implements AggregatorFunction {
  ...
  public SumSingleIntAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      LongState state) {
  ...
  public static SumSingleIntAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new SumSingleIntAggregatorFunction(driverContext, channels, new LongState(SumSingleIntAggregator.init()));
  }
  ...
  private void addRawVector(IntVector vVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      state.longValue(SumSingleIntAggregator.combine(state.longValue(), vValue));
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    if (seen.getBoolean(0)) {
      state.longValue(SumSingleIntAggregator.combine(state.longValue(), sum.getLong(0)));
      state.seen(true);
    }
  }
