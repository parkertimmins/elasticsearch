...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link SumSingleIntAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class SumSingleIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public SumSingleIntGroupingAggregatorFunction(List<Integer> channels, LongArrayState state,
  ...
  public static SumSingleIntGroupingAggregatorFunction create(List<Integer> channels,
      DriverContext driverContext) {
    return new SumSingleIntGroupingAggregatorFunction(channels, new LongArrayState(driverContext.bigArrays(), SumSingleIntAggregator.init()), driverContext);
  }
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        for (int vOffset = vStart; vOffset < vEnd; vOffset++) {
          ...
          state.set(groupId, SumSingleIntAggregator.combine(state.getOrDefault(groupId), vValue));
        }
      }
    }
  }
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        if (seen.getBoolean(valuesPosition)) {
          state.set(groupId, SumSingleIntAggregator.combine(state.getOrDefault(groupId), sum.getLong(valuesPosition)));
        }
      }
    }
  }
