...
/**
 * {@link AggregatorFunction} implementation for {@link SumSingleLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class SumSingleLongAggregatorFunction implements AggregatorFunction {
  ...
  public SumSingleLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      LongState state) {
  ...
  public static SumSingleLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new SumSingleLongAggregatorFunction(driverContext, channels, new LongState(SumSingleLongAggregator.init()));
  }
  ...
  private void addRawVector(LongVector vVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      state.longValue(SumSingleLongAggregator.combine(state.longValue(), vValue));
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    if (seen.getBoolean(0)) {
      state.longValue(SumSingleLongAggregator.combine(state.longValue(), sum.getLong(0)));
      state.seen(true);
    }
  }
