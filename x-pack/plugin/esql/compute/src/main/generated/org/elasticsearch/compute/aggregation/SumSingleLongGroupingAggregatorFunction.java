...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link SumSingleLongAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class SumSingleLongGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public SumSingleLongGroupingAggregatorFunction(List<Integer> channels, LongArrayState state,
  ...
  public static SumSingleLongGroupingAggregatorFunction create(List<Integer> channels,
      DriverContext driverContext) {
    return new SumSingleLongGroupingAggregatorFunction(channels, new LongArrayState(driverContext.bigArrays(), SumSingleLongAggregator.init()), driverContext);
  }
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        for (int vOffset = vStart; vOffset < vEnd; vOffset++) {
          ...
          state.set(groupId, SumSingleLongAggregator.combine(state.getOrDefault(groupId), vValue));
        }
      }
    }
  }
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        if (seen.getBoolean(valuesPosition)) {
          state.set(groupId, SumSingleLongAggregator.combine(state.getOrDefault(groupId), sum.getLong(valuesPosition)));
        }
      }
    }
  }
